...
function App() {
  ...
  // --------------------------------------------------------------
  const modelOptions = [
    { label: "Curtain 1", url: "https://trybuygo.com/wp-content/uploads/2024/12/curtain1.glb" },
    { label: "Curtain 2", url: "https://trybuygo.com/wp-content/uploads/2024/12/curtain2.glb" },
    { label: "Curtain 3", url: "https://trybuygo.com/wp-content/uploads/2024/12/curtain3.glb" },
    { label: "Curtain 4", url: "https://trybuygo.com/wp-content/uploads/2024/12/curtain4.glb" },
  ];
